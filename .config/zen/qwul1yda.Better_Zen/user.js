...
/* Zen value: true
 * Disables gelocation - improve privacy */
user_pref("geo.enabled", false);

/* Zen value: true
 * Disables WebRTC IP leaks - improve privacy */
user_pref("media.peerconnection.enabled", false);

/* Zen value: true
 * Disables captive portal checks - improve privacy */
user_pref("network.captive-portal-service.enabled", false);
user_pref("network.connectivity-service.enabled", false);
...
/* Zen value: false
 * Disable API commonly used for fingerprinting */
user_pref("webgl.disabled", true);

/* Zen value: true
 * Disabled API commonly used for fingerprinting */
